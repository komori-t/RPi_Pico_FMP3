 ...
 * タイマ割込みハンドラ登録のための定数
 */
#define INTNO_TIMER_PRC1 (RP2040_TIMER0_IRQn + 16)       /* 割込み番号 */
#define INHNO_TIMER_PRC1 (0x00010000 | INTNO_TIMER_PRC1) /* 割込みハンドラ番号 */
#define INTNO_TIMER_PRC2 (RP2040_TIMER1_IRQn + 16)       /* 割込み番号 */
#define INHNO_TIMER_PRC2 (0x00020000 | INTNO_TIMER_PRC2) /* 割込みハンドラ番号 */
